      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Align(
              alignment: AlignmentDirectional(-0.12, -0.89),
              child: Container(
                width: 305.1,
                height: 288.43,
                decoration: BoxDecoration(
                  color: Color(0x0011908D),
                ),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8.0),
                  child: Image.asset(
                    'assets/images/WhatsApp_Image_2026-09-23_at_08.33.11.png',
                    width: double.infinity,
                    height: double.infinity,
                    fit: BoxFit.cover,
                  ),
            ...
            Align(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8.0),
                  child: Image.asset(
                    'assets/images/WhatsApp_Image_2026-09-23_at_08.54.17_(1).png',
                    width: double.infinity,
                    height: double.infinity,
                    fit: BoxFit.cover,
                  ),
            ...
            Align(
              alignment: AlignmentDirectional(0.0, 0.0),
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 315.0, 20.0, 0.0),
                child: Column(
                  ...
                  children: [
                      ...
                      child: GradientText(
                        ...
                        style:
                            FlutterFlowTheme.of(context).displayMedium.override(
                                  ...
                                  color: Color(0xFF66250B),
                                  fontSize: 50.0,
                                  letterSpacing: 0.0,
                                  fontWeight: FontWeight.w500,
                                  fontStyle: FontStyle.italic,
                                ),
                        colors: [Color(0xFF66250B)],
                    ...
                    Padding(
                      ...
                      child: Text(
                        'O Sabor Mineiro bem pertinho de você Uai!',
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed(CadPagWidget.routeName);
                        },
                        text: 'Criar conta',
                        icon: Icon(
                          Icons.person_add,
