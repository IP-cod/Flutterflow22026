...
import 'endereco_pag_model.dart';
export 'endereco_pag_model.dart';

class EnderecoPagWidget extends StatefulWidget {
  const EnderecoPagWidget({super.key});

  static String routeName = 'EnderecoPag';
  static String routePath = '/enderecoPag';

  @override
  State<EnderecoPagWidget> createState() => _EnderecoPagWidgetState();
}

class _EnderecoPagWidgetState extends State<EnderecoPagWidget> {
  late EnderecoPagModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnderecoPagModel());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF67331A),
        appBar: AppBar(
          backgroundColor: Color(0xFFD09D64),
          automaticallyImplyLeading: false,
          title: Text(
            'Registre seu Endereço',
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.network(
                    'https://images.unsplash.com/photo-1655487609710-c113f9762c05?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyM3x8cGFkYXJpYXxlbnwwfHx8fDE3ODg4NzE1NDh8MA&ixlib=rb-4.1.0&q=80&w=1080',
                    width: double.infinity,
                    height: double.infinity,
